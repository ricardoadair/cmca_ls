...
public class PolygonDataTypes {
    ...
    static final String POLYGON_TYPE = "Área"; //Starts with capital, same as Java class

    static {
      // Assign the constants
      TRACK_PLAN_DATA_MODEL = createDataModel();
      TRACK_PLAN_DATA_TYPE = TRACK_PLAN_DATA_MODEL.getDeclaredType(POLYGON_TYPE);
    }
    ...
    private static TLcdDataModel createDataModel() {
      ...
      TLcdDataType type = dataModel.getDeclaredType(POLYGON_TYPE);
